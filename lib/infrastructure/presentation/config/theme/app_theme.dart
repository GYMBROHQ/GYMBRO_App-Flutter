...
class AppTheme {
  ...
  static AppBarTheme get _lightAppBarTheme => AppBarTheme(
    ...
    centerTitle: true,
    titleTextStyle: AppTypography.h5.copyWith(color: AppColors.neutral900),
  ...
  static AppBarTheme get _darkAppBarTheme => AppBarTheme(
    ...
    surfaceTintColor: Colors.transparent,
    centerTitle: true,
    titleTextStyle: AppTypography.h5.copyWith(color: DarkAppColors.textPrimary),
    iconTheme: const IconThemeData(
  ...
  static OutlinedButtonThemeData get _darkOutlinedButtonTheme =>
      OutlinedButtonThemeData(
        style: OutlinedButton.styleFrom(
          ...
          minimumSize: const Size(0, AppButtonSizes.heightMd),
          shape: RoundedRectangleBorder(borderRadius: AppBorderRadius.button),
          side: const BorderSide(color: DarkAppColors.primary500, width: 1.5),
          textStyle: AppTypography.button,
        ),
      );
  ...
  get _darkInputDecorationTheme => InputDecorationTheme(
    filled: true,
  ...
  static NavigationBarThemeData get _darkNavigationBarTheme =>
      NavigationBarThemeData(
        ...
        labelTextStyle: WidgetStateProperty.resolveWith((states) {
          ...
          return AppTypography.caption.copyWith(color: DarkAppColors.textMuted);
        }),
        iconTheme: WidgetStateProperty.resolveWith((states) {
          if (states.contains(WidgetState.selected)) {
            return const IconThemeData(
